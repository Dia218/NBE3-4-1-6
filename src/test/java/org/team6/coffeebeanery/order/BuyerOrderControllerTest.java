...
import org.team6.coffeebeanery.order.controller.BuyerOrderController;
...
public class BuyerOrderControllerTest {
    ...
    void t1() throws Exception {
        ...
        resultActions
                .andExpect(handler().handlerType(BuyerOrderController.class))
